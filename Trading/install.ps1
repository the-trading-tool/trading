...
# Aufhol-Laeufe sind PowerShell-Skripte, keine Python-Module. Windows hat die
# 5.1 immer an diesem Pfad; catchup.ps1 ist bewusst ASCII und BOM-frei, damit
# 5.1 es unabhaengig von der Codepage liest.
